...
all_vars$RF_class_25_c = all_vars$pred_all_data > 0.2
all_vars$RF_class_50_c = all_vars$pred_all_data > 0.4
all_vars$RF_class_75_c = all_vars$pred_all_data > 0.6
...
clv_data$RF_class_25_c = clv_data$prediction_prob_c > 0.2
clv_data$RF_class_50_c = clv_data$prediction_prob_c > 0.4
clv_data$RF_class_75_c = clv_data$prediction_prob_c > 0.6
clv_data$pext_class = clv_data$pext_avg < 0.1
...
Well, the difference is still non-existent in ClinVar benign vs pathogenics, but the difference is much more obvious in the model performance in low and medium bins.
